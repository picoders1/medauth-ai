...
| | |
|---|---|
| generated_at | `2026-08-25T07:06:42+00:00` |
| git_commit | `bf8ba18` |
| samples_per_arm | `5` |
| temperature | `0.0` |
...
|---|---|---|---|---|---|---|---|---|
| primary | `sha256:ae0a6a0b7a54` | `json_schema` | **no** | 0/5 | 0/5 | 0.0000 | - | - |
| primary | `sha256:ae0a6a0b7a54` | `tool_call` | yes | 5/5 | 5/5 | 1.0000 | yes | 863.2 |
| primary | `sha256:ae0a6a0b7a54` | `json_object` | **no** | 0/5 | 0/5 | 0.0000 | - | - |

## Unsupported modes

| role | mode | reason |
|---|---|---|
| primary | `json_schema` | UpstreamFailureError: model path failed after 2 attempts: upstream returned 502 |
| primary | `json_object` | UpstreamFailureError: model path failed after 2 attempts: upstream returned 502 |
