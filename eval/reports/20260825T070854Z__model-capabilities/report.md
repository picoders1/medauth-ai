...
| | |
|---|---|
| generated_at | `2026-08-25T07:08:54+00:00` |
| git_commit | `bf8ba18` |
| samples_per_arm | `5` |
| temperature | `0.0` |
...
|---|---|---|---|---|---|---|---|---|
| primary | `sha256:31d69bc24c21` | `json_schema` | yes | 5/5 | 5/5 | 1.0000 | **no** | 713.9 |
| primary | `sha256:31d69bc24c21` | `tool_call` | **no** | 0/5 | 0/5 | 0.0000 | - | - |
| primary | `sha256:31d69bc24c21` | `json_object` | yes | 5/5 | 0/5 | 0.0000 | yes | 803.4 |
| alternate-1 | `sha256:ae0a6a0b7a54` | `json_schema` | **no** | 0/5 | 0/5 | 0.0000 | - | - |
| alternate-1 | `sha256:ae0a6a0b7a54` | `tool_call` | yes | 5/5 | 5/5 | 1.0000 | yes | 1025.7 |
