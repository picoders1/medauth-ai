...
| **R-11** | The model does not support reliable structured output, making closed schemas unenforceable in practice. | High | Phase 0 capability probe decides the strategy on evidence; bounded repair with the repair rate as a first-class metric. | Open | 0 |
