...
| **Enterprise SSO is deployed** | A live identity provider configured, pointed at, and exercised | — | **Refused.** No issuer has been pointed at a real provider and no deployment has been performed. Implementation, verification against a live IdP, deployment and production-readiness are four different claims |
